...
- [The Big Agent Harness Architecture Comparison](/architectures) — a normalized view of which responsibilities LangGraph owns and which remain delegated to the application.
