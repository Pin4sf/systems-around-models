...
revision_id: revision-harness-engineering-study-guide-003
...
You can read this page in one sitting. It condenses the foundations of a forty-chapter course assembled from public agent runtimes, coding systems, workflow engines, memory research, evaluation methods, security work, and failure studies. Every detailed chapter is now published; this page gives you the map first.
...
- [AI Job Search](https://github.com/MadsLorentzen/ai-job-search/tree/ab91c60cc47147d9416f0af758fb5e2d109956ce) — a bounded document-and-review workflow with explicit artifact checks and human-owned submission.
