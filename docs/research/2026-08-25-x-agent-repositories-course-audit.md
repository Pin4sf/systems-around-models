...
|---|---|---|---|---|
| OpenViking | [`volcengine/OpenViking@7ee7561`](https://github.com/volcengine/OpenViking/commit/7ee75611212a1fe502da037b59afa04cbcf5e2ed) | [`v0.4.16`](https://github.com/volcengine/OpenViking/releases/tag/v0.4.16), published 2026-08-21 | 2026-08-25T10:28:54Z | Main project AGPL-3.0; CLI and examples use separate Apache-2.0 licenses. |
| AgentMemory | [`rohitg00/agentmemory@e04ba88`](https://github.com/rohitg00/agentmemory/commit/e04ba88819c365c9acf9d6661ea802143e728bd6) | [`v0.9.29`](https://github.com/rohitg00/agentmemory/releases/tag/v0.9.29), published 2026-08-16 | 2026-08-23T14:54:08Z | Apache-2.0. Dependencies, connected hosts, and model providers keep their own terms. |
...
**Existing coverage.** The private research corpus has a dedicated OpenViking deep dive and downstream memory design references. Its last source refresh was `v0.4.5` on 2026-06-26, so the architecture is covered but the current `v0.4.16` series is not. The public site's readiness audit already marks OpenViking as needing refresh; there is no public OpenViking architecture page or essay.
...
**Existing coverage.** The private research corpus discusses AgentMemory-derived lifecycle, graph, hybrid-search, and hook ideas, but it is a concept synthesis rather than a current implementation-pinned AgentMemory dossier. No dedicated public source manifest, architecture record, or essay exists.
...
1. **OpenViking `v0.4.16` refresh** — diff the existing `v0.4.5` dossier, recheck identity, retrieval trace, session commit, server/enterprise boundaries, and retain the AGPL constraint.
