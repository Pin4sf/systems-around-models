...
|---|---|---|---|
| Harness Chapters 1–28 | Released; Chapters 25–28 refreshed to revision 2 | Clean-room chapters grounded in the release-pinned source manifests named in each article | Review corrections and reader feedback before revision 3; edit Chapters 29–32 as the next curriculum batch |
