...
|---|---|---|---|
| Harness Chapters 1–40 | Released; Chapters 25–27 at revision 2, Drover at revision 3, and the short guide at revision 3 | Clean-room chapters grounded in current first-party documentation, release-pinned repositories, primary research, and explicit author-reported boundaries | Review corrections and reader feedback; revalidate live product documentation before any capability comparison changes |
