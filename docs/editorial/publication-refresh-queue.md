...
|---|---|---|---|
| Harness Chapters 2–20 | Released | Original clean-room chapters grounded in the source manifests named in each article | Review corrections and reader feedback before revision 2; edit Chapters 21–24 as the next curriculum batch |
