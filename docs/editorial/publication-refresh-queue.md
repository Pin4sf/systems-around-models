...
|---|---|---|---|
| Harness Chapters 2–11 | Released | Original clean-room chapters grounded in the source manifests named in each article | Review corrections and reader feedback before revision 2; edit Chapters 12–16 as the next curriculum batch |
